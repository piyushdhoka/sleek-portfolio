---
title: 'Cybercoach'
description: 'Built an AI-powered cybersecurity education platform with RAG-based tutoring, adaptive learning paths, and proctored assessments for job-ready skills.'
...
![Cybercoach architecture](/project/cybach.png)
